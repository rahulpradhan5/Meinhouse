        ...
        <div class="row">
         ...
         <div class="card card-info">
             ...
             <div class="m-4">
                ...
                <a href="{{ url("mississauga-pro-profile/$auth_id") }}" class="btn btn-warning float-end btn-sm"><i class="fas fa-link"></i> Create Link</a>
                <!-- card beginning -->
                        <div style="display:flex; width:100%;border-bottom: rgb(216, 212, 212) 1px solid ;">
                                    ...
                                    <div style="width:35%; " class="sub-div-left">
                                        ...
                                        <div style="display:flex;border-bottom: rgb(216, 212, 212) 1px solid;">
                                            ...
                                            <?php
                                             $professional=DB::table('users')->where('id',auth()->user()->id)->first();
                                             $details=DB::table('pro_details')->where('pro_id',auth()->user()->id)->first();
                                             $services=DB::table('pro_services')->where('pro_id',auth()->user()->id)->pluck('service_id');
                                            ?>
                                            <div class="mb-3">
