   ...
   <div class="row">
      <div class="col-md-12">
         <div class="card">
            ...
            <form class="form-horizontal" method="POST" action="{{url('pro/proff-banking') }}" name="banking" id="banking" enctype="multipart/form-data">
               @csrf
               <div class="card-body">
                  ...
                  <div class="form-group row mb-2">
                     ...
                     <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{ $details->account_no }}" id="account_no" name="account_no">
                     </div>
                  </div>
                  <div class="form-group row mb-2">
                  ...
                  <label for="inputfile" class="col-sm-2 col-form-label">Insurance</label>
                     <div class="col-sm-10">
                        <div class="field_wrapper">
                           <input type="file" class="form-control" name="insurance" id="insurance" accept="image/jpeg,image/png,application/pdf,image/jpg><br>
                               <img src="" height="100px" width="100px">
                               <img src="{{ url('public/upload/pro_doc/'.$details->insurance) }}"   height="100px" width="100px">
                           </div>
