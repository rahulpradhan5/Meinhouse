            ...
            <div class="row">
              ...
              <!-- form start -->
                ...
                <div class="form-group row">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label"><B>:</B></label>
                    <div class="col-sm-6">
                    <img src="https://meinhaus.ca/services/1635107858.jpg" height="50" width="100">
                    </div>
                  </div>
                ...
                <div class="form-group row">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label"><B>:</B></label>
                    <div class="col-sm-6">
                      <span class=""><img src="https://meinhaus.ca/services/1635107859.jpg" height="50" width="100"></span>
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label"><B>:</B></label>
                    <div class="col-sm-6">
                      <span class="" style="word-break: break-all;">Demolition Services include flooring, walls, trim, non supporting lumber, digging, and bundling of debris for bin disposal.</span>
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <label for="inputEmail3" class="col-sm-2 col-form-label"><B>:</B></label>
                    <div class="col-sm-6">
                      <span class="">{{ $pro->created_at }}</span>
                    </div>
                  </div>
