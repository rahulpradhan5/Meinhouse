                ...
                <div class="col-md-12" style="padding:0;">
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link " id="nav-home-tab" href="{{url('dashboard')}}"
                                role="tab" 
                                style="background-color:#ccc;font-family: 'Poppins', sans-serif;">Upcoming</a>
                            <a class="nav-item nav-link active" id="nav-profile-tab"  href="{{url('past')}}"
                                role="tab" 
                ...
                <div class="col-md-12 tab-content py-3" id="nav-tabContent">
                      ...
                      background-color: #ffffff38;">
                         ...
                         @php
                          ...
                          @endphp
                        <a href="{{url('booking-details')}}/{{$value1->id}}">
                        ...
                        <div class="border-bottom-inner-side mt-2 text-center" style="border: none!important;padding-bottom: 0%!important;padding: 0px!important;">
                          ...
                          <img src="{{url('public/image/no-data3.png')}}" height="132px">
                        </div>
                        @endforelse
                    </div>
                  </div>
