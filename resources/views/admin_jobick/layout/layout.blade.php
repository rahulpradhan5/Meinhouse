...
<head>
	...
	<link href="{{url('assets/jobick/vendor/select2/css/select2.min.css')}}" rel="stylesheet">
	...
	<link href="{{url('assets/jobick/vendor/bootstrap-daterangepicker/daterangepicker.css')}}" rel="stylesheet">
     <!--Clockpicker -->
    <link href="{{url('assets/jobick/vendor/clockpicker/css/bootstrap-clockpicker.min.css')}}" rel="stylesheet">
     <!--asColorpicker -->
    <link href="{{url('assets/jobick/vendor/jquery-asColorPicker/css/asColorPicker.min.css')}}" rel="stylesheet">
     <!--Material color picker -->
    <link href="{{url('assets/jobick/vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css')}}" rel="stylesheet">
	
     <!--Pick date -->
    <link rel="stylesheet" href="{{url('assets/jobick/vendor/pickadate/themes/default.css')}}">
    <link rel="stylesheet" href="{{url('assets/jobick/vendor/pickadate/themes/default.date.css')}}">
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        <!--**********************************
            Nav header start
        ***********************************-->
        @include('admin_jobick.partials.header')
	...
	<div class="content-body">
        ...
        ***********************************-->
        ...
        @include('admin_jobick.partials.footer')
