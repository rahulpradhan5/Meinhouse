...
@section('content')
     <div class="row page-titles">
        ...
        <li class="breadcrumb-item "><a href="{{url('admin/dashboard')}}">Home</a></li>
         <li class="breadcrumb-item "><a href="{{url('admin/multiple-estimate')}}">Estimate</a></li>
            <li class="breadcrumb-item active"><a href="">Add Estimate</a></li>
        </ol>
    </div>
    @if (count($errors) > 0)
                    ...
                    <form class="form-horizontal" method="POST" name="add-sales" id="add-sales"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="user_id" class="form-control" placeholder="User Name"
                                        required>
                                </div>
                            </div>
