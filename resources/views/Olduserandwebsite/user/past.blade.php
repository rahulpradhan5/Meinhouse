            ...
            <div class="row">
                <div class="col-md-12" style="padding:0;">
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link " id="nav-home-tab" href="http://meinhausca.com/public/user/dashboard"
                                role="tab"
                                style="background-color:#ccc;font-family: 'Poppins', sans-serif;">Upcoming</a>
                            <a class="nav-item nav-link active" id="nav-profile-tab"  href="http://meinhausca.com/public/user/dashboard/past"
                                role="tab"
                ...
                <div class="col-md-12 tab-content py-3" id="nav-tabContent">
                      ...
                      background-color: #ffffff38;">
                          ...
                          <img src="http://meinhausca.com/public/image/no-data3.png" height="132px">
                        </div>
                                            </div>
                  </div>
              </div>
