                    ...
                    <div class="widget widget_nav_menu clearfix">
                        ...
                        <ul class="footer_services">
                            @foreach ($popular_services as $value)
                                <li><a href=""> <i class="fa fa-hand-o-right"
                            ...
                            <li><a href="http://meinhausca.com/public/termsandconditions"> <i class="fa fa-hand-o-right"
