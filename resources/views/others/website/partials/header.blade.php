                            ...
                            <div class="container">
                                ...
                                <div class="site-branding">
                                    ...
                                    <a class="home-link" href="{{url('/')}}" title="MeinHaus" rel="home">
                                        ...
                                        <img id="logo-img" class="img-center" src="{{asset('theme/images/logo-img.png')}}" alt="logo-img">
                                ...
                                <div id="site-navigation" class="site-navigation">
                                   ...
                                   <div class="header-btn">
                                            ...
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-btn-color-black" href="{{route('admin-logout')}}">LOGOUT</a>
                                    ...
                                    <div class="header-btn">
                                            ...
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-btn-color-black" href="{{url('prologin')}}">PRO LOGIN</a>

                                        </div>

                                        <div class="header-btn">

                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-btn-color-black" href="{{url('userlogin')}}">LOGIN</a>
                                          ...
                                          <li><a href="{{url('blog')}}">Blog</a></li>
                                            ...
                                            <li><a>{{Auth::user()->name}}</a>
                                                <ul>
                                                    ...
                                                    <li><a href="{{route('offer-detail')}}">Offers</a></li>
                                                </ul>
                                            </li>
                                            @endif
