      ...
      <div class="pro_user_form" style="background-image: linear-gradient(#fff, #adada357);">
        <div class="container">
          <div class="row">
           ...
           <form method="POST" action="{{route('update-profile')}}" id="update-profile" name="update-profile" enctype="multipart/form-data">
            @csrf
           <div class="row">
              <div class="col-12">
                    ...
                    <div class="row">
                      <div class="col-2">
                          <div class="profile-picture-container">
                              ...
                              <img class="profile-picture"  id="blah" src="{{Auth::user()->user_image ? url('/pros_images/'.Auth::user()->user_image): asset('/pros_images/user-dump.png')}}"
                              height="90" width="100" style="border-radius: 50%">
                              <label class="profile-picture-button" for="file-input">
                              <img src="{{url('theme/images/icon-edit.png')}}">
                              </label>
                      ...
                      <div class="col-10">
                        ...
                        @endif
                          ...
                          <div class="form-group">
                           ...
                           <input type="text" name="name" id="name" class="form-control profile-input" placeholder="Name" value="{{Auth::user()->name}}">
                            
                          </div>
                          <div class="form-group">
                            <h5 class="pull-center" style="font-size: 17px;margin-bottom: 11px;">EMAIL</h5>
                           <input type="text" name="email" id="email" class="form-control profile-input" placeholder="Email" value="{{Auth::user()->email}}" disabled="" style="background-color: #e9ecef!important;cursor: no-drop;">
                            
                          </div>
                          <div class="form-group">
                            <h5 class="pull-center" style="font-size: 17px;margin-bottom: 11px;">Phone Number</h5>
                           <input type="text" name="phone_no" id="phone_no" class="form-control profile-input" placeholder="Phone Number" value="{{Auth::user()->phone}}">    
                          </div>
              ...
              <div class="col-12">
                 <div class="featured-imagebox featured-imagebox-post ttm-box-view-left-image row">
                          ...
                          <div class="col-md-12">
                            ...
                            @forelse($addresses as $value)
                             <div class="box1" style="margin-top: 11px;">
                                <p>{{$value->name}}<i class='fa fa-edit edit-address' id="top-icon" onclick="editAddress('{{$value->id}}')"></i></p> 
                                <span class="block">{{$value->area}} , {{$value->locality}} , {{$value->city}}</span>
                                 <span class="block" style="clear: both;">{{$value->state}}</span>
                                  <span class="block" style="clear: both;">Pin Code:</span> <span class="block">{{$value->pin_code}}</span>
                                   @if($value->primary == 1)
                                   <span class="block" style="clear: both; color: #000; font-weight: bold;">DEFAULT ADDRESS</span>
                                   @else
                                   <a href="{{route('add-primary',$value->id)}}">
                                   <span class="block" style="clear: both; color: #000; font-weight: bold;">MAKE THIS DEFAULT ADDRESS</span>
                                 </a>

                                  @endif
                              <a href="{{route('delete-address',$value->id)}}"><i class="fa fa-trash" id="delete-icon"></i></a>
                   ...
                   <form method="POST" action="{{route('add-address')}}" id="add-address" name="add-address" enctype="multipart/form-data">
                       @csrf
                     <div class="row add-addttess" style="display: none;">
                        <div class="col-md-12">
                    ...
                    <form method="POST" action="{{route('edit-address-post')}}" id="edit-address" name="edit-address" enctype="multipart/form-data">
                       @csrf
                      <input type="hidden" class="custom-control-input" name="edit_id" id="edit_id">
