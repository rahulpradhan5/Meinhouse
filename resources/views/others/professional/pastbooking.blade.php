...
<style type="text/css">
 ...
 <div class="content-wrapper">
   ...
   <div class="container-fluid">
         ...
         <div class="tab">
           <a href="{{url('proff-bookings')}}"><button class="tablinks" style="border-right: solid;border-color: #001f3f29;">Upcoming</button></a> 
           <a href="{{url('past-bookings')}}"><button class="tablinks active" onclick="openCity(event, 'Past')">Past</button></a>
         </div>
         <!-- /.card-header -->
         <!-- form start -->
						...
						<div class="col-12 ">
						   ...
						   ?></b></h2>
                             ...
                             <div class="card-footer">
                                 ...
                                 <div class="text-right btntext" style="background: #BE2813;">
                                    <i class="fas fa-user"></i>
                                    Rejected
                                  </div>
                                   @endif
                                   @if($orderDetails->status == 3)
                                  <div class="text-right btntext" style="background: #EF5931;padding-right: 1.5%;">
                                    <i class="fas fa-user"></i>
                                    User Cancel
                                  </div>
                                   @endif
                                   @if($orderDetails->status == 5)
                                  <div class="text-right btntext" style="background: #467C24;">
                                    <i class="fas fa-user"></i>
                                    Completed
                                  </div>
                                   @endif
