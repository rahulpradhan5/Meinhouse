...
<style type="text/css">
    .pro_image{
          height: auto   ;
          background-image:url("http://meinhausca.com/public/theme/images/row-bgimage-11.jpg");
...
<div class="container-fluid" style="padding-top:0px;">
    <div class="row home_slider_image pro_image" >
       <div class="col-md-4">
           <div class="logoM" style="z-index:60;padding: 20px 40px;">
            <a class="home-link position-relative" href="https://meinhaus.ca" title="MeinHaus" rel="home">
                <img id="logo-img" class="img-center" src="https://meinhaus.ca/public/theme/images/logo-img.png"
                    alt="logo-img" style="width: 250px;">
            </a>
        </div>
           <div class="ttm_single_image-wrapper mb-35">
             <img class="img-fluid-pro" src="http://meinhausca.com/public/theme/images/single-img-eight.png" alt="">
                            </div>
                ...
                @if(Session::has('message'))
                   ...
                   <div class="login_form_pro">
                      <h4 class="text-center pro_login_title" style="margin-bottom: 5%;">SIGN UP FOR  PRO USER ACCOUNT</h4>
                                                           <form method="POST" action="{{route('proff-register-post')}}" >
                         @csrf
                            <div class="row">
                               <div class="col-6">
                            ...
                            <div class="form-group">
                                     <div class="form-check">
                                        ...
                                        <label class="form-check-label">By signing up with MeinHaus, you are agreeing to Meinhaus <a href="{{url('terms')}}"><u> Terms and Conditions</u></a></label>
                                     </div>
                ...
                <div class="container" >
                    ...
                    <div class="row no-gutters">
                        <div class="col-md-3">
                            <div class="featured-icon-box style9 text-left">
                                <div class="featured-icon">
                                       <img class="advantage-icon" src="http://meinhausca.com/public/theme/images/network-b27c9403ff96c1a4764b818a30b38c9b315fdca8a56067264ffbf0f1b1a5e7fa.png">
                                </div>
                        ...
                        <div class="col-md-3">
                            <div class="featured-icon-box style9 text-left">
                                <div class="featured-icon">
                                 <img class="advantage-icon" src="http://meinhausca.com/public/theme/images/alert-c3c91c39eb2d36f10820576a8f1611d4db3aa1fc587db0c04a8f0ede7e844d60.png">
                                </div>
                                <div class="featured-content">
                                    <div class="featured-title">
                        ...
                        <div class="col-md-3">
                            <div class="featured-icon-box style9 text-left">
                                <div class="featured-icon">
                                    <img class="advantage-icon" src="http://meinhausca.com/public/theme/images/invoice-85dfafae54bea15fc2c790259e5d27c11b8f6b90850dd1e1d45b8e033e93b7ab.png">
                                </div>
                                <div class="featured-content">
                                    <div class="featured-title">
                        ...
                        <div class="col-md-3">
                            <div class="featured-icon-box style9 text-left">
                                <div class="featured-icon">
                                   <img class="advantage-icon" src="http://meinhausca.com/public/theme/images/fees-dc8948721bd1feb5317fa9f9fea3f69302f869e9bfc503ec627d63a9de7620cc.png">
                                </div>
                                <div class="featured-content">
                                    <div class="featured-title">
