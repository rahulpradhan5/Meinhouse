...
<style type="text/css">
        .ttm-page-title-row.prologin_image.text-center {
            background-image: url('https://meinhaus.ca/public/pro_landing_assets/img/login-bg.jpg');
            height: auto;
        }
        ...
        <div class="ttm-page-title-row prologin_image text-center">
            ...
            <div class="container loginContent" style="padding-top: 50px;">
                    ...
                    <div class="col-md-6 ">
                        <div class="login_form pro">
                            <h2 class="text-center pro_login_title">Login</h2>
                             <form method="POST" action="{{url('login-post')}}" name="login" id="login">
                ...
                <div style="margin-top: 5%">
                     <a href="{{route('forget password')}}" class="forgot-pass">I Forgot My Password </a>
                </div>
              </form>
                        ...
                        <div style="margin-top: 5%">
                            <a href="{{ url('register') }}"><button class="btn btn-md btn-block"
