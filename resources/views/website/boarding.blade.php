...
<link rel="shortcut icon" href="http://meinhausca.com/public/theme/images/favi.png" sizes="32x32"/>

<!-- bootstrap -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/bootstrap.min.css"/>

<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"/>

<!-- animate -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/animate.css"/>

<!-- owl-carousel -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/owl.carousel.css">

<!-- fontawesome -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/font-awesome.css"/>

<!-- themify -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/themify-icons.css"/>
<!-- flaticon -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/flaticon.css"/>

<!-- REVOLUTION LAYERS STYLES -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/layers.css">



<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/settings.css">

<!-- prettyphoto -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/prettyPhoto.css">

<!-- shortcodes -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/shortcodes.css"/>

<!-- main -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/main.css"/>

<!--Color Switcher Mockup-->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/color-switcher.css" >

<!-- responsive -->

<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/responsive.css"/>
<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/theme/css/custom.css"/>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css">
<link rel="stylesheet" href="http://meinhausca.com/public/theme/css/simplepicker.css">
<link rel="stylesheet" type="text/css" href="https://npmcdn.com/flatpickr/dist/themes/material_blue.css">
<link rel="stylesheet" type="text/css" href="http://meinhausca.com/public/adminlte/dist/css/stylemain.css">
                        ...
                        <div class="site-header-menu-inner ttm-stickable-header">
                            ...
                            <div class="container">
                                ...
                                <div class="site-branding">
                                    ...
                                    <a class="home-link" href="http://meinhausca.com/public" title="MeinHaus" rel="home">

                                        <img id="logo-img" class="img-center" src="http://meinhausca.com/public/theme/images/logo-img.png" alt="logo-img">
                                ...
                                <div id="site-navigation" class="site-navigation">
                                            ...
                                            <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-border ttm-btn-color-black" href="http://meinhausca.com/public/pro/logout">LOGOUT</a>
                                    ...
                                    <nav id="menu" class="menu">
                                        ...
                                        <ul class="dropdown">
                                           ...
                                           <li class="active"><a href="http://meinhausca.com/public">Home</a></li>
                                            
                                            <li><a href="http://meinhausca.com/public/aboutus">About Us</a></li>
                                            
                                            <li><a href="http://meinhausca.com/public/our-services">Our Services</a></li>
                                            
                                          <li><a href="http://meinhausca.com/public/blog">Blog</a></li>
                                           

                                            <li><a href="http://meinhausca.com/public/contactus">Contact Us</a></li>

                                            <!--<li><a href="http://meinhausca.com/public/help">Help</a></li>-->
...
<div class="container-fluid" id="grad1">
                     ...
                     <div class="form-group">
                        ...
                        <b>Services</b>
                         <select class="js-example-responsive" name="services[]" id="services" multiple placeholder="Choose Services" required>
                            ...
                            <option id="ser_0" value="7">Appliance Install</option>
                              
                            <option id="ser_1" value="1">Appliance Repair</option>
                              
                            <option id="ser_2" value="29">Architecture</option>
                              
                            <option id="ser_3" value="30">Basement Renovation</option>
                              
                            <option id="ser_4" value="32">Bathroom Renovation</option>
                              
                            <option id="ser_5" value="2">Carpet &amp; Upholstery Cleaning</option>
                              
                            <option id="ser_6" value="38">catering service</option>
                              
                            <option id="ser_7" value="39">Cutting edge</option>
                              
                            <option id="ser_8" value="3">Decks and Fences</option>
                              
                            <option id="ser_9" value="11">Eavestrough Repair</option>
                              
                            <option id="ser_10" value="12">Electrical Companies</option>
                              
                            <option id="ser_11" value="14">Flooring &amp; Tile Services</option>
                              
                            <option id="ser_12" value="15">Furniture Assembly</option>
                              
                            <option id="ser_13" value="16">Garage Door Repair</option>
                              
                            <option id="ser_14" value="17">Gas Services</option>
                              
                            <option id="ser_15" value="40">grass cutting</option>
                              
                            <option id="ser_16" value="31">Kitchens</option>
                              
                            <option id="ser_17" value="33">Landscaping</option>
                              
                            <option id="ser_18" value="24">Locksmith</option>
                              
                            <option id="ser_19" value="26">Mold Remediation</option>
                              
                            <option id="ser_20" value="27">Moving &amp; Delivery</option>
                              
                            <option id="ser_21" value="28">Painting Companies</option>
                              
                            <option id="ser_22" value="25">Pest Control</option>
                              
                            <option id="ser_23" value="34">Plumbing</option>
                              
                            <option id="ser_24" value="41">Roof Polishing</option>
                              
                            <option id="ser_25" value="18">Roofing, Siding, and Trim</option>
                              
                            <option id="ser_26" value="13">Seasonal Snow Clearing Quote</option>
                              
                            <option id="ser_27" value="19">Smart Home Install</option>
                              
                            <option id="ser_28" value="21">Stone, Masonry, &amp; Asphalt</option>
                              
                            <option id="ser_29" value="37">tiffin service</option>
                              
                            <option id="ser_30" value="22">Tile &amp; Grout Cleaning</option>
                              
                            <option id="ser_31" value="5">Tree Services</option>
                              
                            <option id="ser_32" value="23">Water and Fire Damage</option>
                              
                            <option id="ser_33" value="36">Waterproofing &amp; Excavation</option>
                              
                            <option id="ser_34" value="4">Window &amp; Gutter Cleaning</option>
                          </select>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.js"></script>
    ...
    <script src="http://meinhausca.com/public/theme/js/tether.min.js"></script>

    <script src="http://meinhausca.com/public/theme/js/bootstrap.min.js"></script>

    <script src="http://meinhausca.com/public/theme/js/color-switcher.js"></script> 

<!--     <script src="http://meinhausca.com/public/theme/js/jquery.easing.js"></script>    
 -->
<!--     <script src="http://meinhausca.com/public/theme/js/jquery-waypoints.js"></script>    --> 

    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.1/jquery.validate.min.js"></script> 
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.1/additional-methods.min.js"></script>

    <script src="http://meinhausca.com/public/theme/js/owl.carousel.js"></script>

    <script src="http://meinhausca.com/public/theme/js/jquery.prettyPhoto.js"></script>

    <script src="http://meinhausca.com/public/theme/js/numinate.min.js"></script>

    <script src="http://meinhausca.com/public/theme/js/main.js"></script>

    <!-- Revolution Slider -->

    <script src="http://meinhausca.com/public/theme/js/jquery.themepunch.tools.min.js"></script>

    <script src="http://meinhausca.com/public/theme/js/jquery.themepunch.revolution.min.js"></script>

    <script src="http://meinhausca.com/public/theme/js/slider.js"></script>

    <script src="http://meinhausca.com/public/theme/js/validation.js"></script>
	<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>
    <script src="http://meinhausca.com/public/theme/js/simplepicker.js"></script>
    <!--trial-->
