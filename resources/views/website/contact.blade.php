            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 pr-60 res-767-pr-15">
                     ...
                     <form id="ttm-contactform" class="ttm-contactform wrap-form clearfix" method="post" action="{{route('contactUsPost')}}">
                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <label>
                                        ...
                                        <span class="text-input"><i class="fa fa-mobile-phone"></i><input name="phone" type="number" value="" placeholder="Cell Phone" required="required" id="phone"></span>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="ttm-rounded-shadow-box pt-40 pr-50 pb-55 pl-50 box-shadow2 res-767-mt-40 clearfix">
                            ...
                            <ul class="ttm_contact_widget_wrapper">
                                ...
                                <li><i class="fa fa-mobile"></i>1(844) 777-HAUS (4287)</li>
