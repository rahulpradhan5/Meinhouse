...
<style type="text/css">
        .ttm-page-title-row.prologin_image.text-center {
            background-image: url('https://meinhausca.com/public/theme/images/login-head.jpg');
            height: auto;
        }
.ttm-page-title-row.text-center {
    ...
    <div class="position-relative">
        <div class="position-absolute logoM" style="z-index: 101;padding: 70px 40px;">
        ...
        <div class="ttm-page-title-row prologin_image text-center">
            ...
            <div class="container loginContent" style="padding-top: 50px;">
                ...
                <div class="row pt-4">
                 ...
                 -->
                 @csrf
                 @if(Session::has('job_pay_suc'))
                        <p    class="alert {{ Session::get('alert-class', 'alert-success') }}">{{ Session::get('job_pay_suc') }}</p>
                     @endif 
                ...
                <div style="margin-top: 5%">
                     <a href="{{route('forget-password-proff')}}" class="forgot-pass">I Forgot My Password </a>
                </div>
              </form>
                        ...
                        <div style="margin-top: 5%">
                            <a href="{{ url('pro-register') }}"><button class="btn btn-md btn-block"
                                    style="background-color: #fda12b;height: 55px!important;">NEW TO MEINHAUS ?
                                </button></a>
                        </div>
                    </div>
                    <div class="col-md-3"></div>
